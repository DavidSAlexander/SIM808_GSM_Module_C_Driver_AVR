...
#define TWBR_REG      SFR_MEM8(0x70)
#define TWSR_REG      SFR_MEM8(0x71)
#define TWAR_REG      SFR_MEM8(0x72)
#define TWDR_REG      SFR_MEM8(0x73)
#ifndef TWCR_REG
#define TWCR_REG      SFR_MEM8(0x74)
#endif
...
#define TW_READ_BIT		                                   0x01
#define TW_WRITE_BIT	                                   0x00
