...
volatile uint8 *DDR_REG[]  = {&DIO_DDRA,  &DIO_DDRB,  &DIO_DDRC,  &DIO_DDRD,  &DIO_DDRE,  &DIO_DDRF,  &DIO_DDRG};
volatile uint8 *PIN_REG[]  = {&DIO_PINA,  &DIO_PINB,  &DIO_PINC,  &DIO_PIND,  &DIO_PINE,  &DIO_PINF,  &DIO_PING};
volatile uint8 *PORT_REG[] = {&DIO_PORTA, &DIO_PORTB, &DIO_PORTC, &DIO_PORTD, &DIO_PORTE, &DIO_PORTF, &DIO_PORTG};
